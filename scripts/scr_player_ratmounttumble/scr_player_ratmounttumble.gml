function scr_player_ratmounttumble()
{
	...
	if ((check_wall(x + hsp, y) && !scr_solid_slope(x + hsp, y) && !place_meeting(x + hsp, y, obj_rollblock) && !place_meeting(x + hsp, y, obj_rattumble) && !place_meeting(x + hsp, y, obj_destructibles)) or place_meeting(x, y, obj_timedgate))
	{
