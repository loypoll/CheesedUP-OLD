...
/*
var anon_F78A665C_997 = function()
{
	global.mt_game_frame_button = new gameframe_std_haxe_class(7, "game_frame_button");
	global.mt_gameframe_delayed_item = new gameframe_std_haxe_class(8, "gameframe_delayed_item");
	global.mt_gameframe_std_haxe_class = new gameframe_std_haxe_class(-1, "gameframe_std_haxe_class");
...
function gameframe_log()
{
	if (!global.gameframe_debug)
		exit;
	var _s = "[Gameframe]";
	for (var __g = 0; __g < argument_count; _s += (" " + gameframe_std_Std_stringify(_arg)))
	{
...
function gameframe_update()
{
	...
	if (global.gameframe_can_input && mouse_check_button_pressed(1))
	{
		if (__titleHit)
		{
...
function game_frame_button_create()
{
	var _this = [global.mt_game_frame_button];
	array_copy(_this, 1, global.mq_game_frame_button, 1, 15);
	array_set(_this, 15, game_frame_button_draw_icon_default);
	array_set(_this, 14, game_frame_button_draw_underlay_default);
	array_set(_this, 13, game_frame_button_update_default);
	array_set(_this, 12, game_frame_button_get_width_default);
...
function game_frame_button_get_width_default()
{
	return sprite_get_width(argument0[3]);
}
function game_frame_button_update_default()
{
	
}
function game_frame_button_draw_underlay_default()
{
	if (argument0[9])
	{
		if (argument0[8])
...
function game_frame_button_draw_icon_default()
{
...
function game_frame_button_set_name()
{
	array_set(argument0, 1, argument1);
}
function game_frame_button_get_name()
{
	return argument0[1];
}
function game_frame_button_set_custom()
{
	array_set(argument0, 2, argument1);
}
function game_frame_button_get_custom()
{
	return argument0[2];
}
function game_frame_button_set_icon()
{
	array_set(argument0, 3, argument1);
}
function game_frame_button_get_icon()
{
	return argument0[3];
}
function game_frame_button_set_subimg()
{
	array_set(argument0, 4, argument1);
}
function game_frame_button_get_subimg()
{
	return argument0[4];
}
function game_frame_button_set_margin_left()
{
	array_set(argument0, 5, argument1);
}
function game_frame_button_get_margin_left()
{
	return argument0[5];
}
function game_frame_button_set_margin_right()
{
	array_set(argument0, 6, argument1);
}
function game_frame_button_get_margin_right()
{
	return argument0[6];
}
function game_frame_button_set_hover()
{
	array_set(argument0, 7, argument1);
}
function game_frame_button_get_hover()
{
	return argument0[7];
}
function game_frame_button_set_pressed()
{
	array_set(argument0, 8, argument1);
}
function game_frame_button_get_pressed()
{
	return argument0[8];
}
function game_frame_button_set_enabled()
{
	array_set(argument0, 9, argument1);
}
function game_frame_button_get_enabled()
{
	return argument0[9];
}
function game_frame_button_set_fade()
{
	array_set(argument0, 10, argument1);
}
function game_frame_button_get_fade()
{
	return argument0[10];
}
function game_frame_button_set_click()
{
	array_set(argument0, 11, argument1);
}
function game_frame_button_get_click()
{
	return argument0[11];
}
function game_frame_button_set_get_width()
{
	array_set(argument0, 12, argument1);
}
function game_frame_button_get_get_width()
{
	return argument0[12];
}
function game_frame_button_set_update()
{
	array_set(argument0, 13, argument1);
}
function game_frame_button_get_update()
{
	return argument0[13];
}
function game_frame_button_set_draw_underlay()
{
	array_set(argument0, 14, argument1);
}
function game_frame_button_get_draw_underlay()
{
	return argument0[14];
}
function game_frame_button_set_draw_icon()
{
	array_set(argument0, 15, argument1);
}
function game_frame_button_get_draw_icon()
{
	return argument0[15];
}
function gameframe_button_get_combined_width()
{
	var _w = 0;
	var __g = 0;
	for (var __g1 = global.gameframe_button_array; __g < array_length(__g1); _w += (_b[5] + _b[12](_b) + _b[6]))
	{
		var _b = __g1[__g];
		__g++;
	}
...
function gameframe_button_get_combined_offset()
{
...
function gameframe_button_update()
{
	...
	var _i = 0;
	for (var __g1 = array_length(global.gameframe_button_array); _i < __g1; _i++)
	{
...
function gameframe_button_draw()
{
	var _dpiScale = global.gameframe_effective_scale;
	var _i = 0;
	for (var __g1 = array_length(global.gameframe_button_array); _i < __g1; _i++)
...
function gameframe_button_add_defaults()
{
	...
	var _minimize = game_frame_button_create("minimize", global.gameframe_spr_buttons, 0, function()
	{
		gameframe_minimize();
	});
	if (!global.gameframe_has_native_extension)
	...
	var _maxrest = game_frame_button_create("maxrest", global.gameframe_spr_buttons, 1, function()
	{
		if (global.gameframe_isMaximized_hx)
			gameframe_restore();
		else
	...
	array_set(_maxrest, 13, function()
	{
	...
	var _close = game_frame_button_create("close", global.gameframe_spr_buttons, 3, function()
	{
		game_end();
	});
	array_set(_close, 14, function()
	{
		var __alpha = 0;
		if (argument0[8])
		{
...
function gameframe_tools_rect__new()
{
...
function gameframe_tools_rect_get_window_rect()
{
...
function gameframe_restore(_force = false)
{
	...
	if (!_force && !global.gameframe_isMaximized_hx && !global.gameframe_isFullscreen_hx)
		exit;
...
function gameframe_set_fullscreen(fullscreen)
{
	gameframe_set_fullscreen_1(fullscreen);
}
...
function gameframe_set_fullscreen_1(mode, wasfs = false)
{
	if (global.gameframe_debug)
		gameframe_log("setFullscreen(mode:", mode, ", wasfs:", wasfs, ")");
	if (mode == 1 || mode == 2)
	{
		gameframe_button_reset();
		gameframe_drag_stop();
...
function gameframe_set_window_cursor()
{
...
function gameframe_caption_draw_border_default()
{
	draw_sprite_stretched_ext(global.gameframe_spr_border, window_has_focus() ? 1 : 0, argument0, argument1, argument2, argument3, global.gameframe_blend, 1);
}
function gameframe_caption_draw_caption_rect_default()
{
...
function gameframe_drag_set_rect()
{
...
function gameframe_tools_keyctl_create_key()
{
	return [argument0, false, false];
}
function gameframe_tools_keyctl_update_key()
{
	var _down0 = argument0[1];
	var _down1 = keyboard_check_direct(argument0[0]) != false;
...
{
	var _i = 0;
	for (var __g1 = array_length(global.gameframe_tools_keyctl_keys); _i < __g1; _i++)
		array_set(array_get(global.gameframe_tools_keyctl_keys, _i), 1, false);
}
function gameframe_tools_keyctl_update()
{
	if (!(window_has_focus() && (keyboard_check_direct(91) != false || keyboard_check_direct(92) != false)))
	{
		gameframe_tools_keyctl_reset();
		exit;
	}
...
function gameframe_std_Std_stringify()
{
	if (argument0 == undefined)
		return "null";
	...
	if (is_struct(argument0))
	{
		...
		for (_i = -1; ++_i < _n; _s += gameframe_std_Std_stringify(variable_struct_get(argument0, array_get(_fields, _i))))
		{
			if (_i > 0)
				_s += ", ";
		}
...
function gameframe_std_haxe_class() constructor
{
