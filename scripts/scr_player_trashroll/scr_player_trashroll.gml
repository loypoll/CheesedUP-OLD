function scr_player_trashroll()
{
	...
	if (((check_wall(x + xscale, y) or place_meeting(x + xscale, y, obj_ghostwall)) && !place_meeting(x + hsp, y, obj_destructibles) && !place_meeting(x + hsp, y, obj_rattumble)) or place_meeting(x, y, obj_timedgate))
	{
		image_index = 0;
