function scr_player_cheesepepjump()
{
	...
	{
		if (sprite_index == spr_cheesepepjumpstart or sprite_index == spr_cheesepep_walljump)
	...
	if (check_wall(x + sign(movespeed), y) && !place_meeting(x, y + 1, obj_slope) && !place_meeting(x + sign(movespeed), y, obj_ratblock))
	{
