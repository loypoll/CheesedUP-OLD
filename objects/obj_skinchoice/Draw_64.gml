...
draw_clear(make_color_rgb(121, 103, 151));

// jesus christ
var pizza = spr_pizzacollect1halloween;
draw_sprite_ext(pizza, 0, bg_pos, bg_pos, curve, curve, 0, c_white, 0.5 * curve);
draw_sprite_ext(pizza, 0, bg_pos - 64, bg_pos, curve, curve, 0, c_white, 0.5 * curve);
draw_sprite_ext(pizza, 0, bg_pos - 64, bg_pos - 64, curve, curve, 0, c_white, 0.5 * curve);
draw_sprite_ext(pizza, 0, bg_pos, bg_pos - 64, curve, curve, 0, c_white, 0.5 * curve);
draw_sprite_ext(pizza, 0, bg_pos + 64, bg_pos, curve, curve, 0, c_white, 0.5 * curve);
draw_sprite_ext(pizza, 0, bg_pos, bg_pos + 64, curve, curve, 0, c_white, 0.5 * curve);
draw_sprite_ext(pizza, 0, bg_pos + 64, bg_pos + 64, curve, curve, 0, c_white, 0.5 * curve);
