...
if (sprite_index != scaredspr && x != targetplayer.x && state != states.pizzagoblinthrow && bombreset <= 0 && grounded && targetplayer.state != 16 && targetplayer.state != states.ghostpossess)
{
