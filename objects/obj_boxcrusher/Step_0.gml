if (y == ystart && obj_player.boxxed == 0 && obj_player.state != 33 && obj_player.state != 34 && obj_player.state != 35 && (obj_player.x > (x - 50) && obj_player.x < (x + 50)) && (obj_player.y > y && obj_player.y < (y + 200)))
{
	vsp = 10;
