if (global.panic == 1 && global.fill > 0 && !instance_exists(obj_ghostcollectibles) && !global.tutorial_room)
	global.fill -= 0.2;
if (global.fill <= 0 && global.panic == 1 && !global.tutorial_room && !instance_exists(obj_pizzaface))
{
