if (room == rm_editor)
	exit;
if (obj_player.state == 47 || (obj_player.state == states.chainsaw && (obj_player.tauntstoredstate == 47 || obj_player.tauntstoredstate == 38)) || obj_player.state == 48 || obj_player.state == 38 || obj_player.state == 49)
