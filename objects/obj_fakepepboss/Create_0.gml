...
fakepep_set_attack(0, 0, 0, 80, default_deformed_timer);
fakepep_set_attack(0, 1, 1, 80, default_deformed_timer);
fakepep_set_attack(0, 2, 2, 120, default_deformed_timer);
fakepep_set_attack(0, 3, 3, 120, 500);
fakepep_set_attack(0, 4, 4, 120, default_deformed_timer);
fakepep_set_attack(0, 5, 5, 120, 700);
fakepep_set_attack(1, 0, 0, 80, 0);
fakepep_set_attack(1, 1, 1, 80, 0);
fakepep_set_attack(1, 2, 2, 120, 0);
fakepep_set_attack(1, 3, 3, 120, 0);
fakepep_set_attack(1, 4, 4, 120, 0);
fakepep_set_attack(1, 5, 5, 120, 0);
fakepep_set_attack(2, 0, 6, 0, default_deformed_timer);
fakepep_set_attack(2, 1, 6, 0, default_deformed_timer);
fakepep_set_attack(2, 2, 6, 0, default_deformed_timer);
fakepep_set_attack(2, 3, 6, 0, default_deformed_timer);
fakepep_set_attack(2, 4, 6, 0, default_deformed_timer);
fakepep_set_attack(2, 5, 6, 0, default_deformed_timer);
projectile_list = -4;
