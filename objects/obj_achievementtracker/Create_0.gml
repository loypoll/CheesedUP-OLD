...
add_achievement_notify("pal_unfunny", -4, function()
{
...
add_achievement_notify("pal_mooney", -4, function()
{
	var type = argument0[0];
	if (type == 57)
		palette_unlock(name, "mooney", 15);
}, false, "Palettes", "mooney");
add_achievement_notify("pal_sage", -4, function()
{
	var type = argument0[0];
	if (type == 5)
	{
...
add_achievement_notify("pal_money", -4, function()
{
	var type = argument0[0];
	if (type == 5)
	{
...
add_achievement_notify("pal_blood", -4, function()
{
	var type = argument0[0];
	if (type == 5)
	{
...
add_achievement_notify("pal_tv", -4, function()
{
	var type = argument0[0];
	if (type == 5)
	{
...
add_achievement_notify("pal_dark", -4, function()
{
	var type = argument0[0];
	var arr = argument0[1];
...
add_achievement_notify("pal_shitty", -4, function()
{
	var type = argument0[0];
	if (type == 52)
		palette_unlock(name, "shitty", 9);
}, false, "Palettes", "shitty");
add_achievement_notify("pal_golden", -4, function()
{
	var type = argument0[0];
	if (type == 5)
	{
...
add_achievement_notify("pal_funny", -4, function()
{
	var type = argument0[0];
	var arr = argument0[1];
...
add_achievement_notify("pal_itchy", -4, function()
{
	var type = argument0[0];
	var arr = argument0[1];
...
add_achievement_notify("pal_pizza", -4, function()
{
	var type = argument0[0];
	if (type == 53)
...
add_achievement_notify("pal_goldemanne", -4, function()
{
	var type = argument0[0];
	if (type == 51)
	{
...
add_achievement_notify("pal_pp", -4, function()
{
	var type = argument0[0];
	if (type == 53)
	{
...
add_achievement_notify("pal_war", -4, function()
{
	var type = argument0[0];
	var arr = argument0[1];
	if (type == 5 && arr[0] == "war")
...
add_achievement_notify("pal_john", -4, function()
{
	var type = argument0[0];
	var arr = argument0[1];
...
add_achievement_notify("farm2", -4, function()
{
	var type = argument0[0];
	if (type == 6)
